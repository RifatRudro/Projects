...
def task_4():
    """
    You will use Backtrader to implement a BollingerBands overbought and oversold strategy by
    creating a strategy class that inherit bt.strategy.
    This strategy uses:
    ...
    The entry condition should follow the BollingerBands overbought and oversold strategy.
